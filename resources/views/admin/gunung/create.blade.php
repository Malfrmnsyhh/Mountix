...
@section('title', 'Tambah Gunung - Admin Mountix')
...
<div class="mb-8">
    ...
    <h1 class="text-3xl font-black text-neutral-dark">Tambah Gunung Baru</h1>
    <p class="text-neutral-dark/60">Lengkapi formulir di bawah untuk menambahkan data gunung baru.</p>
</div>
            ...
            <div class="bg-white p-8 rounded-3xl border border-neutral-light shadow-sm space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}" required class="w-full px-4 py-3 bg-neutral-light border border-transparent rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white outline-none transition-all">
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi" value="{{ old('lokasi') }}" required placeholder="Contoh: Magelang, Jawa Tengah" class="w-full px-4 py-3 bg-neutral-light border border-transparent rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white outline-none transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="ketinggian" value="{{ old('ketinggian') }}" required class="w-full px-4 py-3 bg-neutral-light border border-transparent rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white outline-none transition-all">
                    ...
                    <div>
                        ...
                        <select name="status_buka" required class="w-full px-4 py-3 bg-neutral-light border border-transparent rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white outline-none transition-all appearance-none">
                            <option value="1" {{ old('status_buka') == '1' ? 'selected' : '' }}>Buka</option>
                            <option value="0" {{ old('status_buka') == '0' ? 'selected' : '' }}>Tutup</option>
                        </select>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="5" required class="w-full px-4 py-3 bg-neutral-light border border-transparent rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white outline-none transition-all">{{ old('deskripsi') }}</textarea>
            ...
            <div class="bg-white p-8 rounded-3xl border border-neutral-light shadow-sm space-y-6">
                <div>
                    ...
                    <div id="image-preview-container" class="w-full aspect-video bg-neutral-light rounded-2xl overflow-hidden mb-4 border-2 border-dashed border-neutral-dark/10 flex items-center justify-center">
                        <i data-lucide="image" class="w-10 h-10 text-neutral-dark/20"></i>
                    </div>
                    ...
                    <button type="button" onclick="document.getElementById('foto_cover').click()" class="w-full py-3 bg-neutral-light hover:bg-neutral-dark/10 text-neutral-dark text-sm font-bold rounded-2xl transition-all flex items-center justify-center gap-2">
                        <i data-lucide="upload" class="w-4 h-4"></i> Pilih Foto
                    </button>
                    <p class="text-[10px] text-neutral-dark/40 mt-2">Maksimal 2MB. Format: JPG, PNG, WEBP.</p>
